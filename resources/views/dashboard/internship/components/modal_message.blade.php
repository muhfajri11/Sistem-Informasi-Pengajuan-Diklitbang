                ...
                <div class="row">
                    <div class="col-12 col-sm-6 mb-3 d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h4 class="text-right" id="name_msg">Lorem ipsum dolor sit amet lorem ipsum dolor sit amet</h4>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 mb-3 d-flex align-items-center">
                        <i class="fas fa-users-class fa-2x me-4 text-primary"></i>
                        <div>
                            ...
                            <h4 class="text-right" id="jurusan_msg">Lorem ipsum dolor sit amet lorem ipsum dolor sit amet</h4>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 mb-3 d-flex align-items-center">
