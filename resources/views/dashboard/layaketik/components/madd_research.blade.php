    ...
    <div class="modal-dialog modal-lg">
        <form class="modal-content" id="tambah_research" enctype="multipart/form-data" novalidate>
            <div class="modal-header">
                <h3 class="modal-title text-secondary"><i class="fas fa-atom me-2"></i> Ajukan Uji Layak Etik</h3>
                            ...
                            <div class="row">                                
                                <div class="col-12 mb-3">
                                    <div class="form-group">
                                        <label for="judul_daftar">Judul Penelitian</label>
                                        <select class="select2_ mb-2" name="judul" required disabled>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex flex-row mt-2">
                                            ...
                                            <div class="checkbox mx-2">
                                                <input type="checkbox" id="ismultisenter_daftar" name="is_multisenter" class="switchbox" style="display:none">
                                                <label for="ismultisenter_daftar" class="toggle"><span></span></label>
                                            </div>
                                ...
                                <div class="col-12 mb-2">
                                    <div class="form-group">
                                        <label for="suratpengantar_daftar">Surat Pengantar</label>
                                        <div class="input-group">
                                            <div class="form-file">
                                                <input type="file" class="form-file-input form-daftar form-control" id="suratpengantar_daftar" name="surat_pengantar" required>
                                            </div>
