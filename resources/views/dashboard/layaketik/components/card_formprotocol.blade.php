                    ...
                    <div id="c" class="tab-pane fade">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="ringkasan_protocol_a" name="ringkasan_protocol_a"></textarea>
                                <hr>
                                ...
                                <textarea class="ringkasan_protocol_b" name="ringkasan_protocol_b"></textarea>
                            </div>
                        </div>
                    </div>
                    <div id="d" class="tab-pane fade">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="isu_etik" name="isu_etik"></textarea>
                            </div>
                        </div>
                    </div>
                    <div id="e" class="tab-pane fade">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="ringkasan_kajianpustaka" name="ringkasan_kajianpustaka"></textarea>
                            </div>
                        </div>
                    </div>
                    <div id="f" class="tab-pane fade">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="kondisi_lapangan_a" name="kondisi_lapangan_a"></textarea>
                                <hr>

                                <h5 class="mb-2">2. Informasi ketersediaan fasilitas yang tersedia di lapangan yang menunjang penelitian</h5>
                                <textarea class="kondisi_lapangan_b" name="kondisi_lapangan_b"></textarea>
                                <hr>

                                <h5 class="mb-2">3. Informasi demografis / epidemiologis yang relevan tentang daerah penelitian</h5>
                                <textarea class="kondisi_lapangan_c" name="kondisi_lapangan_c"></textarea>
                            </div>
                        </div>
                    </div>
                    <div id="g" class="tab-pane fade">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="disain_penelitian_a" name="disain_penelitian_a"></textarea>
                                <hr>

                                <h5 class="mb-2">2. Deskipsi detil tentang desain penelitian. <i>(p12)</i></h5>
                                <textarea class="disain_penelitian_b" name="disain_penelitian_b"></textarea>
                                <hr>
                                ...
                                <textarea class="disain_penelitian_c" name="disain_penelitian_c"></textarea>
                            </div>
                        </div>
                    </div>
                    <div id="h" class="tab-pane fade">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="sampling_c" name="sampling_c"></textarea>
                            </div>
                        </div>
                    </div>
                    <div id="i" class="tab-pane fade">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="intervensi_a" name="intervensi_a"></textarea>
                                <hr>
                                ...
                                <textarea class="intervensi_b" name="intervensi_b"></textarea>
                                <hr>
                                ...
                                <textarea class="intervensi_c" name="intervensi_c"></textarea>
                                <hr>

                                <h5 class="mb-2">4. Test klinis atau lab atau test lain yang harus dilakukan <i>(p20)</i></h5>
                                <textarea class="intervensi_d" name="intervensi_d"></textarea>
                            </div>
                        </div>
                    </div>
                    <div id="j" class="tab-pane fade">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="monitoring_penelitian" name="monitoring_penelitian"></textarea>
                            </div>
                        </div>
                    </div>
                    <div id="k" class="tab-pane fade">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="penghentian_penelitian" name="penghentian_penelitian"></textarea>
                            </div>
                        </div>
                    </div>
                    <div id="l" class="tab-pane fade">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="adverse_penelitian_a" name="adverse_penelitian_a"></textarea>
                                <hr>
                                ...
                                <textarea class="adverse_penelitian_b" name="adverse_penelitian_b"></textarea>
                            </div>
                        </div>
                    </div>
                    <div id="m" class="tab-pane fade">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="penanganan_komplikasi" name="penanganan_komplikasi"></textarea>
                            </div>
                        </div>
                    </div>
                    <div id="n" class="tab-pane fade">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="manfaat_a" name="manfaat_a"></textarea>
                                <hr>
                                ...
                                <textarea class="manfaat_b" name="manfaat_b"></textarea>
                            </div>
                        </div>
                    </div>
                    <div id="o" class="tab-pane fade">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="keberlanjutan_manfaat" name="keberlanjutan_manfaat"></textarea>
                            </div>
                        </div>
                    </div>
                    <div id="p" class="tab-pane fade">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="informed_consent_a" name="informed_consent_a"></textarea>
                                <hr>
                                ...
                                <textarea class="informed_consent_b" name="informed_consent_b"></textarea>
                            </div>
                        </div>
                    </div>
                    <div id="q" class="tab-pane fade">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="wali_a" name="wali_a"></textarea>
                                <hr>
                                ...
                                <textarea class="wali_b" name="wali_b"></textarea>
                            </div>
                        </div>
                    </div>
                    <div id="r" class="tab-pane fade">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="bujukan_a" name="bujukan_a"></textarea>
                                <hr>
                    ...
                    <div id="s" class="tab-pane fade">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="penjagaan_kerahasiaan_a" name="penjagaan_kerahasiaan_a"></textarea>
                                <hr>
                                ...
                                <textarea class="penjagaan_kerahasiaan_b" name="penjagaan_kerahasiaan_b"></textarea>
                                <hr>
                                ...
                                <textarea class="penjagaan_kerahasiaan_c" name="penjagaan_kerahasiaan_c"></textarea>
                                <hr>

                                <h5 class="mb-2">4. Kemungkinan penggunaan lebih jauh dari data personal atau material biologis/BBT <i>(p37)</i></h5>
                                <textarea class="penjagaan_kerahasiaan_d" name="penjagaan_kerahasiaan_d"></textarea>
                            </div>
                        </div>
                    </div>
                    <div id="t" class="tab-pane fade">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="rencana_analisis" name="rencana_analisis"></textarea>
                            </div>
                        </div>
                    </div>
                    <div id="u" class="tab-pane fade">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="monitor_keamanan" name="monitor_keamanan"></textarea>
                            </div>
                        </div>
                    </div>
                    <div id="v" class="tab-pane fade">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="konflik_kepentingan" name="konflik_kepentingan"></textarea>
                            </div>
                        </div>
                    </div>
                    <div id="w" class="tab-pane fade">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="manfaat_sosial_a" name="manfaat_sosial_a"></textarea>
                                <hr>
                                ...
                                <textarea class="manfaat_sosial_b" name="manfaat_sosial_b"></textarea>
                            </div>
                        </div>
                    </div>
                    <div id="x" class="tab-pane fade">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="hakatas_data" name="hakatas_data"></textarea>
                            </div>
                        </div>
                    </div>
                    <div id="y" class="tab-pane fade">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="publikasi_a" name="publikasi_a"></textarea>
                                <hr>

                                <h5 class="mb-2">Bagaimana publikasi bila hasil riset negatip. <i>(Guideline 24) (p46)</i></h5>
                                <textarea class="publikasi_b" name="publikasi_b"></textarea>
                            </div>
                        </div>
                    </div>
                    <div id="z" class="tab-pane fade">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="pendanaan" name="pendanaan"></textarea>
                            </div>
                        </div>
                    </div>
                    <div id="aa" class="tab-pane fade">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="komitmen_etik_a" name="komitmen_etik_a"></textarea>
                                <hr>
                                ...
                                <textarea class="komitmen_etik_b" name="komitmen_etik_b"></textarea>
                                <hr>
                                ...
                                <textarea class="komitmen_etik_c" name="komitmen_etik_c"></textarea>
                            </div>
                        </div>
                    </div>
                    <div id="bb" class="tab-pane fade">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="daftar_pustaka" name="daftar_pustaka"></textarea>
                            </div>
                        </div>
                    </div>
