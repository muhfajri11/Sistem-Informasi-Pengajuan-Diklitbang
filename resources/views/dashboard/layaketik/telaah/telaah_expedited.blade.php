...
@section('title', "Telaah Lanjut Expedited")
            ...
            <div class="card-body">
				<div class="custom-tab-1">
					<ul class="nav nav-tabs">
						<li class="nav-item">
							<a href="#protocol" data-bs-toggle="tab" class="nav-table nav-link active show">Protokol Expedited</a>
						</li>
						<li class="nav-item">
							...
							<div class="row">
								<div class="col-12">
									<div class="d-flex justify-content-between mb-4">
										<h3 class="font-weight-bold">Protokol Terbaru Expedited</h3>
    ...
    <script>
        $(document).ready(function(){
            ...
            $.extend(dataProtocols, {
                "ajax": {
                    "type": "POST",
                    "url": `{{ route('layaketik.telaah.lanjut.ready', ['status' => 'expedited']) }}`,
                    "timeout": 120000
                },
                "aoColumns": [
                    {
				...
				switch(table){
                    ...
                    if(!$.fn.DataTable.isDataTable('#data_telaah')){
							$.extend(dataTelaah, {
                                "ajax": {
                                    "type": "POST",
                                    "url": `{{ route('layaketik.telaah.lanjut.reviewed', ['status' => 'expedited']) }}`,
                                    "timeout": 120000
                                },
                                "aoColumns": [
                                    {
