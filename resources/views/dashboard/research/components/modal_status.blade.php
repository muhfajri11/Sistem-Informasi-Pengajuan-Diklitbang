        ...
        <form class="modal-content" id="ubah_status" novalidate>
            ...
            <div class="modal-body py-3">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 mb-3">
                        <div class="form-group">
                            <label>Uji Layak Etik</label>
                            <div class="d-flex flex-row mt-2">
                                <strong class="small">Tidak</strong>
                                <div class="checkbox mx-2">
                                    <input type="checkbox" id="switch_etik" name="switch_etik" class="switchbox" style="display:none">
                                    <label for="switch_etik" class="toggle"><span></span></label>
                                </div>
                                <strong class="small">Perlu</strong>
                            </div>
                        </div>
                    </div>
                </div>
